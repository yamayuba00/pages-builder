...
export const pageComponents: Record<string, ComponentConfig> = {
  ...
  column: {
    ...
    defaultProps: {
      ...
      textColor: '#000000',
      itemCount: '3',
      items: 'Star\nFeature 1\nThis is a great feature that helps users\n\nHeart\nFeature 2\nAnother amazing feature for better experience\n\nShield\nFeature 3\nSecure and reliable service you can trust',
      iconSize: '24',
      iconColor: '#3b82f6',
      textSize: '18',
      descriptionSize: '14',
    ...
    propsConfig: [
      { key: 'width', label: 'Width', type: 'select', options: ['w-full', 'w-1/2', 'w-1/3', 'w-2/3', 'w-1/4', 'w-3/4'] },
      { key: 'bgColor', label: 'Background Color', type: 'color' },
      { key: 'padding', label: 'Padding', type: 'select', options: ['p-2', 'p-4', 'p-6', 'p-8', 'p-10'] },
      ...
      { key: 'layoutDirection', label: 'Layout Direction', type: 'select', options: ['vertical', 'horizontal'] },
